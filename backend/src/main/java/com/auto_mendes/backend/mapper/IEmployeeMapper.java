...
public interface IEmployeeMapper {
	...
	EmployeeResponseDTO toDTO(Manager manager);

	EmployeeResponseDTO toDTO(Submanager submanager);

	EmployeeResponseDTO toDTO(Saler saler);
	
	EmployeeResponseDTO toDTO(EmployeeResponseListDTO dto);
}