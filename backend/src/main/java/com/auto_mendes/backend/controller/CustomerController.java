...
public class CustomerController {
	...
	public ResponseEntity<CustomerResponseDTO> updateCustomer(@RequestParam String id, @RequestBody CustomerRequestDTO dto) {
	...
	public ResponseEntity<CustomerResponseDTO> searchCustomerByDocument(@RequestParam String document) {
		CustomerResponseDTO response = customerService.searchCustomerByDocument(document);
