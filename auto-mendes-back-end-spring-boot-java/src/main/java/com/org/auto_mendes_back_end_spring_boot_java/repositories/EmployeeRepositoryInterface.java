...
public interface EmployeeRepositoryInterface extends JpaRepository<Employee, String> {
	...
	default Page<EmployeeResponseDto> findAllEmployees(Pageable pageable) {
		...
		return results.map(obj -> new EmployeeResponseDto((String) obj[0], (String) obj[1], (String) obj[2], (String) obj[3], (String) obj[4], (BigDecimal) obj[5], (String) obj[6], (BigDecimal) obj[7]));
	}
